				...
				<div class="row">
					<div class="col-12 col-xl-8">
						...
						<div class="article__content">
							<a href="category" class="article__category">Documentary</a>
							...
							<iframe src="https://www.youtube.com/embed/isbXIzKPeeY" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							...
							<div class="row">
								<div class="col-12">
									...
									<form action="#" class="subscribe">
										...
										<h4 class="subscribe__title">Subscribe to news</h4>
										<p class="subscribe__text">All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary.</p>
										<div class="sign__group">
							...
							<div class="row">
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-12">
									<div class="interview">
										...
										<h3 class="interview__title"><a href="interview">What Was Ben Affleck Planning for His Unmade 'Batman' Film?</a></h3>
									</div>
								</div>
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-12">
									<div class="interview">
										...
										<h3 class="interview__title"><a href="interview">A Guide to the Work of Ryan Murphy</a></h3>
									</div>
								</div>
							</div>
							<!-- end new items -->
