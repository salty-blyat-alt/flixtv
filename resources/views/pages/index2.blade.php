    ...
    <div class="home">
        <div class="home__carousel owl-carousel" id="flixtv-hero">
            <div class="home__card">
                ...
                <button class="home__add" type="button"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Stephen Schible</a></span>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <p class="card__tagline">«There's more than one way to lose your life to a killer»
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Andrea Di Stefano</a></span>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Samantha Housman</a></span>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Lynette Howell
                                                    Taylor</a></span></li>
                                    </ul>
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="card card--big">
                                ...
                                <div class="card__content">
                                    ...
                                    <ul class="card__info">
                                        <li><span>Director:</span><span><a href="#">Monica Levinson</a></span>
                                        </li>
                                    </ul>
                    ...
                    <div class="section__carousel-wrap">
                        <div class="section__carousel owl-carousel" id="subscriptions">
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Sports broadcasts</a></h3>
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Psychological films</a>
                                </h3>
                                <ul class="card__list card__list--subs">
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Films about space</a></h3>
                                <ul class="card__list card__list--subs">
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Romantic movies</a></h3>
                                <ul class="card__list card__list--subs">
                                    <li>More than 300 movies</li>
                                </ul>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Movies about the middle
                                        ages</a></h3>
                                <ul class="card__list card__list--subs">
                                    <li>More than 300 movies</li>
                                </ul>
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Fairy tales</a></h3>
                                <ul class="card__list card__list--subs">
                                    <li>More than 100 movies</li>
                                </ul>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Best Movies</a></h3>
                                <ul class="card__list card__list--subs">
                                    <li>More than 300 movies</li>
                                </ul>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">The best melodramas</a>
                                </h3>
                                <ul class="card__list card__list--subs">
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Horror movies</a></h3>
                                <ul class="card__list card__list--subs">
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Russian TV Shows</a>
                                </h3>
                                <ul class="card__list card__list--subs">
                                    <li>More than 300 movies</li>
                                </ul>
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Army films</a></h3>
                                <ul class="card__list card__list--subs">
                            ...
                            <div class="card">
                                ...
                                <h3 class="card__title card__title--subs"><a href="details">Cities of the world</a>
                                </h3>
                                <ul class="card__list card__list--subs">
                                    <li>More than 500 movies</li>
                                </ul>
                    ...
                    <div class="section__carousel-wrap">
                        <div class="section__interview owl-carousel" id="flixtv">
                            <div class="interview">
                                ...
                                <h3 class="interview__title"><a href="interview">What Was Ben Affleck Planning for
                            ...
                            <div class="interview">
                                ...
                                <h3 class="interview__title"><a href="interview">Gugu Mbatha-Raw Shares the Films
