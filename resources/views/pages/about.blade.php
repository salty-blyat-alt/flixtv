    ...
    <section class="section section--pb0">
        <div class="container">
            <div class="row">
                <!-- section text -->
                <div class="col-12">
                    <p class="section__text section__text--small">Many desktop publishing packages and <a
                            href="#">web page</a> editors now use Lorem Ipsum as their default model text, and a
                    ...
                    <p class="section__text section__text--small">All the Lorem Ipsum generators on the <b>Internet</b>
            ...
            <div class="row row--grid">
                <div class="col-12 col-lg-4">
                    <div class="step">
                        ...
                        <p class="step__text">It to make a type specimen book. It has survived not only five centuries,
                ...
                <div class="col-12 col-lg-4">
                    <div class="step">
                        ...
                        <p class="step__text">All the Lorem Ipsum generators on the Internet tend to repeat predefined
            ...
            <div class="row row--grid">
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="feature">
                        ...
                        <h3 class="feature__title">Choose your Plan</h3>
                        <p class="feature__text">t to make a type specimen book. It has survived not only five
